<template>
  <div class="results">
    ...
    <p class="search-meta">
      ...
      <span class="total-pages"><b>Pages:</b> {{ total_pages }}</span><!-- I think shawn got it backwards in the video -->
    ...
    <ul>
      <li class="movie-item" v-for="result in results">
        ...
        <div class="ratings">
          ...
          <!-- <span class="rating-category well-liked" v-if="result.vote_average >= 7 && result.vote_average <= 8">Well Liked</span> --><!-- My original guess. -->
